...
class DaMaiTicket:
    ...
    def step1_get_order_info(self, item_id, commodity_param, ticket_price=None):
        ...
        headers = {
            ...
            'tim': '',
            ...
            'sid': ''


        # Cookie: NSC_tqpsut.tkuv.fev.do=ffffffff097f1cec45525d5f4f58455e445a4a4229a0; JSESSIONID=fec8f53d-194a-4eb1-b8f1-ccc97c39c9a4

        # 
        ...
        response = self.session.get('https://sports.sjtu.edu.cn/pc/#/', headers=headers, params=commodity_param)
    ...
    def step3_submit_order(self, submit_order_info, viewer, seat_info=None):
        ...
        if dm_viewer_pc_id_search:
            ...
            if len(set(viewer).intersection(set(all_available_user))) != len(viewer):
                print('-' * 10, '请检查输入的观演人信息与小智网观演人信息是否一致', '-' * 10)
                return False
        ...
        if buy_status.get('success') is True and buy_status.get('module').get('alipayOrderId'):
            print('-' * 10, '抢票成功, 请前往 小智网->我的小智->交易中心->订单管理 确认订单', '-' * 10)
